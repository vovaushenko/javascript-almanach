...
const rx3 = /[a-z]+a[a-z]+/g; // one letter [a-z]  + 'a' + one letter [a-z]  -> 'can' 'man'
const st3 = 'A man can die but once';
console.log(st3.match(rx3));

const rx4 = /\sg\w*/g; //  whitespace + 'g' + any symbol letter or underscore from 0 to several times
const st4 =
	'Some are born great, ' +
...
const rx6 = /\w{3,5}/g; // we want to find letters in range not smaller 3, not greater 5
